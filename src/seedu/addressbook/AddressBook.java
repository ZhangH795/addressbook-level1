...
public class AddressBook {
    ...
    */
    ...
    private static String getDisplayString(ArrayList<HashMap<String,String>> persons) {
        ...
        //string[] display=new string[persons.size()];
        for (int i = 0; i < persons.size(); i++) {
            ...
            messageAccumulator.append('\t')
                              ...
                              .append(LS);
            //display[i]=getIndexedPersonListElementMessage(displayIndex, person);
        }
    ...
    private static HashMap<String, String> makePersonFromData(String name, String phone, String email) {
        ...
        hashMap.put(PERSON_PROPERTY_NAME,name);
        hashMap.put(PERSON_PROPERTY_PHONE,phone);
        hashMap.put(PERSON_PROPERTY_EMAIL,email);
        return hashMap;
        //return person;
